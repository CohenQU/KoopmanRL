...
# load data
#******************************************************************************
Xtrain, Xtest, Xtrain_clean, Xtest_clean, indices_train, indices_test, m, n = data_from_name(args.dataset, noise=args.noise, theta=args.theta, train_size=args.train_size, test_size=args.test_size)
...
for i in range(len(indices_test)):
    ...
    for j in range(length):
        ...
        target_temp = Xtarget[j].data.cpu().numpy().reshape(m,n)
